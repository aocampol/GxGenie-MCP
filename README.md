...
| `gx_create_transaction` | Create a new Transaction with one root level and a key attribute (minimal XPZ + import). Reuses the key attribute if it already exists in the KB. |
